    ...
    float bot_r, float bot_g, float bot_b, float bot_a, float cameraPitch)
{
    ...
    if (background_vao == 0)
    {
        ...
        const GLchar* fs_src =
            ...
            "void main()\n"
            "{\n"
            "frag_color = vec4( (1/abs(int(gl_FragCoord.y+ cp  - time*20)%1000 - 1000.0))*100    , (1/abs(int(gl_FragCoord.y + cp - time*20)%1000 - 500.0))*100, (1/abs(int(gl_FragCoord.y+ cp  - time*20)%1000 - 700.0))*100,1.0);\n"
